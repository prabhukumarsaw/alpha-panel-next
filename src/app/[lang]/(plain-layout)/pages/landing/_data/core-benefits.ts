...
export const coreBenefitsData: CoreBenefitType[] = [
  {
    ...
    description:
      "Panel equips developers with the latest tools to rapidly build scalable, modern dashboards with less friction.",
    points: [
  ...
  },
  {
    ...
    description:
      "With customizable themes and built-in accessibility, Panel adapts seamlessly to your team’s needs and user diversity.",
    points: [
  ...
  },
  {
    ...
    description:
      "Panel includes essential, production-ready features like authentication, form validation, and rich data components.",
    points: [
